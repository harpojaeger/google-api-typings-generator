...
export class App {
    ...
    private processApi(destinationDirectory: string, api: gapi.client.discovery.RestDescription, actualVersion: boolean, url: string) {
        ...
        writer.writeLine(`// This file was generated by https://github.com/harpojaeger/google-api-typings-generator. Please do not edit it manually.`);
        writer.writeLine(`// In case of any problems please post issue to https://github.com/harpojaeger/google-api-typings-generator`);
